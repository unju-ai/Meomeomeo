...
script = wrap("ArcadeCatalog", "src/shared/ArcadeCatalog.luau") + (root / "tests/arcade-smoke.luau").read_text()
with tempfile.TemporaryDirectory(prefix="meo-arcade-test-") as folder:
