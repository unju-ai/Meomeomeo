"""Pawmart item stack smoke. Usage: python3 tools/test-items.py /path/to/luau"""
...
script = wrap("ItemCatalog", "src/shared/ItemCatalog.luau") + (root / "tests/item-smoke.luau").read_text()
