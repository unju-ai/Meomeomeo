...
The Luau smoke checks the hook table (guard math, pull, takedown reset slots, channel interrupt numbers, mana refund, zone pulses) and that Hexkit and Mindwhisker stay on the zero plan. It does not move a character. Walk these three in Studio Play:
...
4. Lock **Hexkit** afterward. Hexkit and Mindwhisker do not gain a guard, a reset, a breakable beam, a lingering zone, a knock, a wick, or a sweater. **Chonk Knight** is in the original-kit pass below. **Bytekit** is in the expansion pass. **Chromeclaw** is in the second expansion pass.
...
4. Lock **Hexkit** afterward. Those buttons stay ordinary: no Guard, no Wick, no cream aura, no knock. **Bytekit**, **Sir Scratchalot**, and **Shadowpounce** are in the expansion pass below. **Chromeclaw**, **Oracle Paws**, and **Archmeow** are in the second expansion pass.
5. Hub modes, fog, party queue, towers, and jungle bots behave as before.
...
4. Lock **Hexkit** afterward. Those buttons stay ordinary: no Data, no Bleed, no Mark, no Vanish, and no kit Guard. Mindwhisker matches that. **Chromeclaw**, **Oracle Paws**, and **Archmeow** are in the pass below.
5. Hub modes, fog, party queue, towers, and jungle bots behave as before.

### Studio live-pass (expansion kits, second batch)

The Luau smoke names **Chrome Plate**, **Lunge Reload**, **Ward Omen**, **Foresight Veil**, **Spell Charge**, and **Charged Meteor**, and checks that Hexkit and Mindwhisker stay on the zero plan. It does not move a character. Walk these three in Studio Play. The earlier kits should still match the passes above. Q is learned at level 1, W at 2, E at 3, and R at 6, same as every other cat.
...
4. Lock **Hexkit** afterward. Those buttons stay ordinary: no Plate, no Omen, no Charge, and no kit Guard. Mindwhisker matches that.
5. Hub modes, fog, party queue, towers, and jungle bots behave as before.
