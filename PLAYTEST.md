...
Hard bots only. Easy and Normal still wait outside a post. Tower HP and gold are unchanged. No yarn-core all-in from the fountain. Control Yarn, peel, and item use stay as they are. The jungle smoke checks which post they join and what still outranks it. It does not move a character.
