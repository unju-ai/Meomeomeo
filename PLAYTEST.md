...
The Luau smoke checks the hook table (guard math, pull, takedown reset slots, channel interrupt numbers, mana refund, zone pulses) and that five expansion cats stay on the zero plan. It does not move a character. Walk these three in Studio Play:
...
4. Lock **Chromeclaw** afterward. The five zero-plan cats do not gain a guard, a reset, a breakable beam, a lingering zone, a knock, a wick, or a sweater. **Chonk Knight** is in the original-kit pass below. **Bytekit** is in the expansion pass.
...
4. Lock **Chromeclaw** afterward. Those buttons stay ordinary: no Guard, no Wick, no cream aura, no knock. **Bytekit**, **Sir Scratchalot**, and **Shadowpounce** are in the expansion pass below.
5. Hub modes, fog, party queue, towers, and jungle bots behave as before.

### Studio live-pass (expansion kits)

The Luau smoke names **Packet Buffer**, **Overclock**, **Honor Bleed**, **Shield Fortify**, **Alley Mark**, and **Smoke Vanish**, and checks that Chromeclaw, Oracle Paws, Archmeow, Hexkit, and Mindwhisker stay on the zero plan. It does not move a character. Walk these three in Studio Play. The original six should still match the passes above.
...
4. Lock **Chromeclaw** afterward. Those buttons stay ordinary: no Data, no Bleed, no Mark, no Vanish, and no kit Guard. Oracle Paws, Archmeow, Hexkit, and Mindwhisker match that.
5. Hub modes, fog, party queue, towers, and jungle bots behave as before.
