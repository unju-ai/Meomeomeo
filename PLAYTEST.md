...
The Luau smokes check the 3:00 wake, the one 90-second return, the non-stacking +8% buff, the pit-versus-body minimap rule, the match-clock copy (`Levi 1:24`, `Levi UP`, `Levi 0:47`, `Levi taken`), and that only Hard mid detours. They do not spawn the beast. Fight it in Studio Play and watch the top-left clock. The six small camps are unchanged. Kitty Caster's take line is unchanged.
...
2. When the clock hits **3:00**, the objective line flips to **Levi UP** and Levi wakes: a large copper ball, about **1100** HP, nameplate **Canal Levi**. It does not sit on the mid lane. It leashes at about **52** studs (a small camp still resets around 38). The line stays **Levi UP** while the body is alive. It does not count down during the fight.
3. With no vision on it, the minimap shows a **square pit** at that canal spot, not the body if someone has dragged it. Walk a ward or a cat into vision: the living body appears (a larger dot), and the world model is visible. Step back out: the body hides again. Fog rules are the same as any camp. The pit marker is still the only map mark. The clock is not a second pit.
