...
2. **Cat Rift Practice.** After draft, open **?**. Title **Cat Rift**. Scan **Movement · Combat · Vision · Shop · Social · Objectives**. Confirm rows for move / AA / QWER / B / F / 4 / 5 / 6 / 7 (via item rows) / G / T / Tab / **AFK** / **F7** / **F8** / V / Mute, fog + ghosts, death recap, purse/CS, Levi, posts → stalls → core, Invite, Kitty Caster, and Tips → Live (not a card). The Practice row reads solo + 2 Blue bots vs 3 Red, and a party caps Blue at 3. Kit shorthand still sits under QWER. **AFK** says 45s **Still there?** and a 90s teammate tag, cleared by move / AA / cast / ping / shop / recall. **F7** says remake under 3:00. **F8** says surrender after 8:00, living humans, bots never vote.
...
1. **Practice**, lock in, fight. While the top-left clock is **under 3:00**, press **F7** (or **Remake**). The chip is peach. In solo Practice you are the only living human, so that press passes immediately: the end screen title is **REMAKE**, the subline is **Fight called early**, and it is not **VICTORY** or **DEFEAT**. Kitty Caster says the fight was called early and does not crown a side. **Practice again** / **Back to lobby** / **Hub** are the same buttons. Bots do not open a vote on their own.
