...
1. Hub → **Cat Rift → Practice**. Last-hit a lane kitten (the killing scratch). An amber **+18g** rises at the corpse with a tiny cream **+1 CS** under it, and a soft coin tick. The purse chip gold and CS both climb by that same last hit. No peach bounty float on that kitten.
...
1. Hub → **Cat Rift → Practice**. Kill a Red bot. A peach **+180g** rises on the victim. There is no cream **+CS** line. The purse gains 180 gold and CS stays put. The amber last-hit float does not play for that kill.
