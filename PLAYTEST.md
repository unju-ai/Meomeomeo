...
2. Dump mana (spam ready casts, or stand off the fountain with no Mana Treat) until **Q** is off cooldown and the slot is already coral from the mana gate. Press **Q**. The same slot pulses again and the line reads **Need mana**. Regain mana and cast: the bolt or slam goes out, and this cue stays quiet.
...
4. Press an unlearned slot: the old "not learned" line stays, with no coral refuse. Hub, Yarn Run, Koi Pond, Yarn Party, and Meme Arcade stay quiet. Scratch arcs, gold / XP floats, and aim rings look the same.
