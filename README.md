...
- Champion auto-attack, assist gold, levels 1–18, death timers, death recap, kill feed, jungle camps, **Canal Levi** (one river epic), scoreboard, fountain regen, minimap
...
- **Purse chip** (above the ability bar, match only) — your gold, CS, and level, plus whether **Yarn Cleave** (280g) fits. Hidden in the hub and the other stalls. After your side takes **Canal Levi**, it adds **+8% damage** for the rest of the match.
