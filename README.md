...
- **Purse chip** (above the ability bar, match only) — your gold, CS, and level, plus whether **Yarn Cleave** (280g) fits. Hidden in the hub and the other stalls.
